import geminiSupport from "../assets/img/Gemini-Support.jpg";
import geminiWebdesign from "../assets/img/compressed/Gemini-Webdesign.webp";
import pexels2 from "../assets/img/compressed/pexels-fauxels-3184418.webp";
import pexels3 from "../assets/img/compressed/pexels-fauxels-3184465.webp";
import heroPic from "../assets/img/compressed/hero-pic.webp";
import picMe from "../assets/img/pic-me.png";
import {
  Zap,
  ShieldCheck,
  Timer,
  ...
  return (
    <div className="space-y-24">
      ...
      <section className="bg-blue-600 text-white py-10 text-center">
        ...
        <a
          href="/kontakt"
          className="inline-block bg-white text-blue-600 px-6 py-2 rounded-full font-medium hover:bg-gray-100 transition hover:shadow-lg"
          data-aos="zoom-in"
          data-aos-delay="200"
          data-aos-duration="600"
        >
