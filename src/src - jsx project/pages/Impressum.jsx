...
export function Impressum() {
  return (
    <div className="prose prose-sm md:prose-base max-w-3xl mx-auto px-4 py-8">
      ...
      <p>
        Telefon:{" "}
        <a href="tel:+4915150738600" className="no-underline">
          +49 151 50738600
        </a>
        <br />
        E-Mail:{" "}
        <a href="mailto:oezdogan.ib@wk-solutions.de" className="no-underline">
          oezdogan.ib@wk-solutions.de
        </a>
      </p>

      <h2>Informationen zu Ihrem Widerrufsrecht</h2>
      <p>
