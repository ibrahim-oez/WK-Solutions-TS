...
import logoSvg from "../assets/img/wk-solutions-logo-svg/path429.svg";

export function KontaktDaten() {
  // Kontaktdaten - zentral definiert für einfache Wartung
  const kontaktInfo = {
    inhaber: "Ibrahim Özdogan",
    telefon: "+49 155 63930981", // Bitte durch echte Nummer ersetzen
    email: "ibrahim.oez@wk-solutions.de", // Bitte durch echte E-Mail ersetzen
    adresse: {
      strasse: "Quellenweg 17", // Bitte durch echte Adresse ersetzen
      plz: "51702",
      ort: "Bergneustadt"
    },
  ...
  // Zusätzliche Services - einfach erweiterbar
  const zusatzServices = [
    // Beispiele für zukünftige Erweiterungen:
    // {
    //   name: "WhatsApp Business",
    //   icon: MessageCircle,
    //   link: `https://wa.me/${kontaktInfo.telefon.replace(/\s/g, '').replace('+', '')}`,
    //   description: "Direkt über WhatsApp kontaktieren"
    // },
    // {
    //   name: "LinkedIn",
    //   icon: ExternalLink,
    //   link: "https://linkedin.com/in/ihr-profil",
    //   description: "Vernetzen Sie sich auf LinkedIn"
    // }
  ];
